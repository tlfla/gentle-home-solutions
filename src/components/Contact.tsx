        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="border-gray-300 focus:border-[#5865F2] focus:ring-[#5865F2]"
              ...
              <Button 
                type="submit"
                className="w-full bg-[#5865F2] hover:bg-[#7B68EE] text-white py-4 text-lg font-semibold transition-all duration-300 hover:scale-105"
              >
                Get My Free Offer
              </Button>
            </form>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-[#5865F2] w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0">
                    <Phone className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#2C3E50] mb-1">Call Us</h4>
                    <a href="tel:+1-813-555-0199" className="text-[#5865F2] hover:text-[#7B68EE] text-lg font-medium transition-colors">
                      (813) 555-0199
                    </a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@sellmyhousenow.com" className="text-[#5865F2] hover:text-[#7B68EE] font-medium transition-colors">
            ...
            <div className="bg-gradient-to-br from-[#5865F2] to-[#7B68EE] rounded-2xl p-8 text-white">
