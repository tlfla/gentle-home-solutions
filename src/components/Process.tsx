...
export const Process = () => {
  ...
  return (
    <section id="process" className="py-24 bg-gradient-to-br from-[#A8C8F0]/15 to-[#B8D4F2]/12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-1/2 -right-5 w-10 h-1 bg-gradient-to-r from-[#7B68EE] to-[#A8C8F0] transform -translate-y-1/2 z-10 rounded-full"></div>
              )}
              ...
              <div className={`${step.cardBg} rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:scale-105 border-2 ${step.border}`}>
                <div className="text-center">
                  ...
                  <div className="bg-[#7B68EE] text-white text-lg font-bold rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-6 shadow-md">
                    {index + 1}
                  </div>
        ...
        <div className="text-center">
          <Button 
            ...
            size="lg"
            className="bg-[#7B68EE] hover:bg-[#A8C8F0] hover:text-[#2C3E50] text-white px-10 py-6 text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg"
          >
